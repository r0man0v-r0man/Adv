...
[
  ...
  { 
    ...
    data: {
      ...
      description: 'Сайт по аренде и продаже недвижимости. Halupa.by - ваш помошник в поиске квартиры или дома для покупки или аренды. Объявления от собственника за наличный и безналичный расчет. Удобный поиск и простота размещения объявления - это halupa.by'
    }
  },
  { 
    path: 'login', 
  ...
  },
  {
    ...
    data: {
      ...
      description: 'Объявления о продаже, аренде домов. Без посредников, объявления от собственников.'
    }
  },
  {
    path: 'not-found',
